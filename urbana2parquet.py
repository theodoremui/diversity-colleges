...
# urbana2parquet.py
# ------------------
# Scraping Urbana University student paper opinion pieces with proxy services & 
# saving to S3
# 
# @author Theodore Mui
...
LISTING_BASE_URL = f"https://dailyillini.com/opinions-stories/page/"
...
def getArticleText(url, numRetries, useProxy=False):
    ...
    while attempts <= numRetries and len(content) < 5: 
        ...
        titleObj = soup.select_one("#storyheadline")
...
#ARTICLE_SELECTOR = \
#    "div#content h2[itemprop^='headline'] > a[href^='https://dailyillini.com/']"
ARTICLE_SELECTOR = \
    ".homeheadline"
