...
DATE_PATTERN = re.compile("https://www.dukechronicle.com/article/(\d+)/(\d+)")
LISTING_BASE_URL = f"https://www.dukechronicle.com/section/{SUBJECT}"
...
#############
# if __name__ == "__main__":
#     url = 'https://www.dukechronicle.com/article/2023/02/021823-birkhead'
#     date_groups = DATE_PATTERN.search(url)
...
# if __name__ == "__main__":
#     print("starting")
#     articleList = getArticleList(LISTING_BASE_URL+"?page="+str(20)+"&per_page=20", 
#                                  RETRIES, True)
#     print("got list")
