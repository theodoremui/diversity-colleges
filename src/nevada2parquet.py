...
# nevada2parquet.py
# ------------------
# Scraping Nevada University student paper opinion pieces with proxy services & 
# saving to S3
# 
# @author Theodore Mui
...
LISTING_BASE_URL = f"https://archive.nevadasagebrush.com/blog/category/opinion/page/"
...
def getArticleText(url, numRetries, useProxy=False):
    ...
    while attempts <= numRetries and len(content) < 5: 
        ...
        titleObj = soup.select_one("h1.post-title")
        contentObj = soup.select_one("div.post-content")
        #contentObj = soup.select("div.post-content")
        #print(contentObj)
        #pp.pprint(contentObj)
        dateObj = soup.select_one("#page-content div.post-meta a.post-date")
        #print(dateObj)
...
ARTICLE_SELECTOR = \
    "div.col-sm-6 h3.title a[href^='https://archive.nevadasagebrush.com/']"
# ARTICLE_SELECTOR = \
#     ".homeheadline"
