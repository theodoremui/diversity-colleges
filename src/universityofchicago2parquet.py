#########################################################################
# universityofchicago2parquet.py
# ------------------
# Scraping University of Chicago student paper opinion pieces with proxy services & 
# saving to S3
# 
# @author Theodore Mui
...
LISTING_BASE_URL = f"https://chicagomaroon.com/category/viewpoints/page/"
...
ARTICLE_SELECTOR = \
    "h2 > a[href^='https://chicagomaroon.com/']"
