...
# georgia2parquet.py
# ------------------
# Scraping Georgia Tech University student paper opinion pieces with proxy services & 
# saving to S3
# 
# @author Theodore Mui
...
LISTING_BASE_URL = f"https://nique.net/category/opinions/page/"
...
def getArticleText(url, numRetries, useProxy=False):
    ...
    while attempts <= numRetries and len(content) < 5: 
        ...
        titleObj = soup.select_one("header.col-12 h1")
        contentObj = soup.select_one("div.entry-content p")
        #print(contentObj)
        #pp.pprint(contentObj)
        dateObj = soup.select_one("header.col-12 p.byline time")
        #print(dateObj)
...
ARTICLE_SELECTOR = \
    "div.col-12 h4.entry-title a[href^='https://nique.net/opinions/']"
# ARTICLE_SELECTOR = \
#     ".homeheadline"
